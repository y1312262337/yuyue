...
public class Scheduling {
	...
	public String toString() {
		return "Scheduling [schedulingId=" + schedulingId + ", doctorId=" + doctorId + ", schedulingDate="
				+ schedulingDate + ", time1=" + time1 + ", time2=" + time2 + ", time3=" + time3 + ", time4=" + time4
				+ ", time5=" + time5 + ", time6=" + time6 + ", count1=" + count1 + ", count2=" + count2 + ", count3="
				+ count3 + ", count4=" + count4 + ", count5=" + count5 + ", count6=" + count6 + ", standby=" + standby
				+ "]";
	}
}